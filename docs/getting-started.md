...
| **2. Align vocabulary** | "Tag" appears in the spec without a definition. Agent runs the Phase 1 grilling loop in `spec-driven-development` and adds `Tag` to `CONTEXT.md`. | Skill | `spec-driven-development` (Phase 1) | `CONTEXT.md` updated |
